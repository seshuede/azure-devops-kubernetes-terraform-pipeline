# aws --version
# aws eks --region us-east-1 update-kubeconfig --name nede1-cluster
# Uses default VPC and Subnet. Create Your Own VPC and Private Subnets for Prod Usage.
# terraform-backend-state-nede1-123
...
data "aws_eks_cluster" "cluster" {
  name = module.nede1-cluster.cluster_id
}
